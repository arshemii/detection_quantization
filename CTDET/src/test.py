...
class PrefetchDataset(torch.utils.data.Dataset):
  ...
  # def pp_model(self, image):
  #     image = image.astype(np.float32)
  #     mean = np.array([104.04, 113.985, 119.85], dtype=np.float32)
  #     #scale = np.array([73.695, 69.87, 70.89], dtype=np.float32)
  #     image -= mean
  #     #image /= scale
